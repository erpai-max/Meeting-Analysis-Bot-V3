...
def load_and_index_data():
    ...
    try:
        ...
        # the data file directly into this 'chat_proxy' folder.
        ...
        logging.error(f"CRITICAL: '{data_path}' not found. The chatbot will not have context. Ensure the GitHub Action ran successfully.")
...
def chat():
    ...
    try:
        # RAG - RETRIEVAL: Find the 15 most relevant records.
        ...
        # RAG - GENERATION: Send context to OpenRouter.
        response = httpx.post(
        ...
        return jsonify({"error": "AI service error"}), e.response.status_code
    except Exception as e:
