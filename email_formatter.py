...
def generate_chart_base64(team_data: List[Dict]) -> str:
    ...
    plt.bar(owners, scores, color="#3b82f6")
        ...
        chart_html += f"""
            <div style="margin-top:20px; text-align:center;">
                ...
                <img src="data:image/png;base64,{chart1}" 
                     alt="Avg Score Chart" style="max-width:100%; border-radius:12px;"/>
            </div>
        """
    if chart2:
        chart_html += f"""
            <div style="margin-top:20px; text-align:center;">
                <h2 style="font-size:18px; font-weight:700; color:#111827;">
                    💰 Pipeline Value Share
                </h2>
                <img src="data:image/png;base64,{chart2}" 
                     alt="Pipeline Chart" style="max-width:100%; border-radius:12px;"/>
            </div>
        """
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="600" align="center"
                    ...
                    <tr><td>
                        <div style="margin-top:20px;">
                            ✅ <b>Total Meetings:</b> {kpi_total_meetings} | 
                            📈 <b>Avg Score:</b> {kpi_avg_score:.1f}% | 
                            💰 <b>Pipeline:</b> {kpi_pipeline}
                        </div>
                    </td></tr>
                    <tr><td style="padding-top:20px;">
                        🚀 <b>AI Summary:</b><br>{safe_summary}
                    </td></tr>
                    <tr><td style="padding-top:20px;">
